...
| [PostHog](docs/integrations/posthog.md) | Продуктова аналітика, теплові карти й запис сесій через first-party nginx-проксі `/ngx-e/`: два апстріми і три локації, окремий рубильник реплею, маскування медданих в адмінці, `iprm_section` замість вимикання трекінгу |
