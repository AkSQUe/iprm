...
| [Ліди Meta Lead Ads](docs/plan-meta-lead-ads.md) | План: приймання лідів з інстант-форм Facebook/Instagram, черга сирих подій, звірка, прив'язка до контактів, адмінка лідів |
