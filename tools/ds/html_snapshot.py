...
NORMALIZERS = [
    ...
    # час доби. /admin/integrations друкує "Перевірено: 13:19:53 ..." -- це
    # єдине джерело шуму, яке знайшлося на 77 сторінках. Нормалізуємо саме
    # ЧАС, а не рядок цілком: дата лишається видимою, тож підміну формату
    # дати знімок усе одно помітить.
