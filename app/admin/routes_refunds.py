...
def refund_form(kind, order_id):
    ...
    # можна не більше того, що надійшло на це замовлення. Після першого
    # часткового повернення (або отриманої доплати різниці тарифу, яка
    # прийшла окремим SUR-) ці числа розходяться, і у форму має
    # підставитись менше з них.
    #
    ...
    suggested = min(basis, order.refund_available)
