...
class Event(TimestampMixin, db.Model):
    ...
    __table_args__ = (
        ...
        db.CheckConstraint(
            ...
            name='ck_events_cpd_points_non_negative',
        ),
    )
    ...
    # Дозволені переходи між статусами. `completed` вважається фінальним,
    # щоб не псувати історію завершених заходів. Решта дозволена.
    STATUS_TRANSITIONS = {
