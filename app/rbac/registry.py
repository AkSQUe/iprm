...
MODULES = (
    ...
    Module('courses', 'Курси', 'learning', ('view', 'manage', 'delete', 'export', 'import'),
           endpoint='admin.courses_list'),
    Module('instances', 'Розклад', 'learning', ('view', 'manage', 'delete', 'export', 'import'),
           endpoint='admin.instances_list'),
    Module('online_courses', 'Онлайн-курси', 'learning', _VM,
    ...
    Module('b2b_requests', 'B2B-заявки', 'requests', ('view', 'manage', 'export'),
           endpoint='admin.b2b_requests_list'),
    Module('meta_leads', 'Ліди Meta', 'requests', ('view', 'manage', 'delete', 'export', 'settings'),
    ...
    Module('blog', 'Блог', 'site', _VMD,
           endpoint='admin.blog_list'),
    Module('media', 'Медіа', 'site', _VMD,
           endpoint='admin.media_library'),
    Module('translations', 'Переклади', 'site', ('manage', 'export', 'import')),
    Module('materials', 'Резервування матеріалів', 'materials',
           ('view', 'manage', 'delete', 'export', 'import'),
           endpoint='admin.materials_overview'),
    Module('cities', 'Локації', 'catalogs', _VMD,
           endpoint='admin.cities_list'),
    Module('specialties', 'Спеціальності', 'catalogs', _VMD,
           endpoint='admin.specialties_list'),
    Module('event_types', 'Типи заходів', 'catalogs', _VMD,
    ...
    Module('backup', 'Резервні копії', 'system', ('view', 'manage', 'delete', 'export'),
