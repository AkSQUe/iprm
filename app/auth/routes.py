...
def account():
    ...
    # шаблоні: запити в Jinja були б непомітні.
    #
    # Саме `eligibility_map`, а не виклик на кожну реєстрацію: поштучно кабінет
    # робив +5 SELECT на реєстрацію (заміряно 10/30/55 запитів на 1/5/10),
    # тобто сторінка дорожчала з кожним курсом користувача.
