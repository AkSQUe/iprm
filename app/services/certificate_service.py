...
def frame_ring_svg(width=794, height=1123, width_mm=210.0,
    ...
    return (
        ...
        '<stop offset="1" stop-color="#7437c9"/>'
        '</linearGradient></defs>'
...
def reissue_lecturer_certificate(instance, trainer, issued_by=None):
    ...
    # виправлений PDF долітає автоматично. Для тренера він так само знову
    # «новий» -- позначка в кабінеті загорається, доки він його не відкриє.
    lc.emailed_at = None
    lc.downloaded_at = None
