...
- **Gradient-text:** обгортати лише 1-2 ключових слова в `<span class="gradient-text">`, не цілий заголовок
...
```
[Badge / Price pill]
[Великий заголовок з gradient-text]
[Підтекст сірим]
...
- [ ] Gradient-text використано для 1-2 ключових слів
